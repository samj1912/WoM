	...
	<div class="jumbotron" id="pageBox">
		...
		<div class="story" id="storyBox">
			<ul id="instructionList" class="list-group">
				...
				<li class="list-group-item"><strong>Defence:</strong><br>
					<ul>
						...
						<li>You cannot place your wall any higher than the 4th row from the top.</li>
					</ul>
				</li>
				<li class="list-group-item"><strong>Attack:</strong><br>
					<ul>
				...
				<li class="list-group-item"><strong>Rooms:</strong><br>
				<ul>
					<li>
					...
					<li>
						...
						<ul id="circlelist">
							<li>
								<strong>Normal way:</strong> To exit from the gate in the top row.
							</li>
							<li>
								<strong>Emergency way:</strong> If you get stuck by the walls, you will have to use the 'Back to grid' button. Using this option costs you twice the amount of treasure looted from that particular room to be deducted from your total treasure.
							</li>
						</ul>
					</li>
				</ul>
				...
				<li class="list-group-item"><strong>Puzzles:</strong><br>
				<ul>
					...
					<li>
						Each puzzle of a particular difficulty and type can only be solved once. Instructions and rules for solving the puzzles will be available in the nav bar during the game.
					</li>
				</ul>
				...
				<ul>
					<li>
						Use W,A,S,D to move up, left, down and right respectively in the defence room.
					</li>
					<li>
						Use arrow keys to move in the attack room.
					</li>
					<li>
						To get out of attack room, go to the door in the top row and press UP arrow.
					</li>
					<li>
