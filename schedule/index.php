...
<body>
	...
	<div id="gameSection">		
		...
		<div id="table1">
			...
			<div class="t1Row" id="t1Row1">
				<div class="t1RowHeader" id="t1Row1Col0">Outer Walls (1)</div>
			...
			<div class="t1Row" id="t1Row2">
				<div class="t1RowHeader" id="t1Row2Col0">Watch Tower (2)</div>
			...
			<div class="t1Row" id="t1Row3">
				<div class="t1RowHeader" id="t1Row3Col0">Main Gate (3)</div>
	...
	<div id="helpBox">
		...
		<div id="helpList" class="list-group">
			<div>
				First column of lower table shows troop ID, list of its forte areas where it can be assigned duty and the number of late shifts assigned to that troop
			</div>
			<div>
			...
			<div class="modal-content">
				...
				<table class="table table-striped table-condensed table-bordered">
					...
					<tr>
						...
						<td>For each allocated long rest (2 or more consecutive days off)</td>
						<td>+3</td>
					</tr>
